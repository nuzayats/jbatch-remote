package org.nailedtothex.jbatch.example.chunkrestart;
...
@Named
public class ChunkRestartItemProcessor implements ItemProcessor {

	private static final Logger log = Logger.getLogger(ChunkRestartItemProcessor.class.getName());
